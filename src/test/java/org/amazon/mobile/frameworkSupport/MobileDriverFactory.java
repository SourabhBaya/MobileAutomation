package org.amazon.mobile.frameworkSupport;
...
import org.amazon.common.util.POMUtil;
import java.io.File;
...
public class MobileDriverFactory {
    ...
    String strChromeDriver = new CLParams().ReadingStringCLParams("Chrome_Driver_Path",new EnvPropVariables().getPreConfigPath(),"PreConfig");
